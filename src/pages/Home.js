    ...
    <div className='homePageWrapper'>
        <div className='formWrapper'>
            ...
            <div className='inputGroup'>
                ...
                <button onClick={joinRoom} className='button joinButton'>Join</button>
                <span className='createInfo'> If you don't have an invite then create a&nbsp; <a onClick={createNewRoom} href='' className='createNewRoom'>new room</a></span>
            </div>
        </div>
        <footer>
